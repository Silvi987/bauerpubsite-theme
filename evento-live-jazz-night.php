<?php get_header(); ?>
  ...
  <main class="container">
    ...
    <div class="event-hero">
      <div class="badge">📅 Venerdì 23 gennaio 2026</div>
      <h2 style="margin-top:10px">Live Jazz Night</h2>
      <p style="margin:10px 0 0; color:rgba(233,238,245,.88)">Serata jazz con trio dal vivo: standard, improvvisazione e atmosfera calda da pub. Luci soffuse, un buon calice o una pinta e via. Ideale per chi vuole chiacchierare senza rinunciare alla musica.</p>
